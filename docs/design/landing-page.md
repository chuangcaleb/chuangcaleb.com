...
- Sections alternate background: parchment (`--bg-page`) for hero and featured, ivory (`--bg-surface`) for overview and projects.
- Max page width: `.max-page`. Prose width: `.max-prose` utility class.
